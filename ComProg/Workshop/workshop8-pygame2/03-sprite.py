...
class Ship(pg.sprite.Sprite):
    def __init__(self,color, width, height):
        ...
        self.image = pg.image.load(r"C:\Users\Nirawit EN\OneDrive\เดสก์ท็อป\CPCU\ComProg\Workshop\workshop8-pygame2\source\img\Ship.png")
...
class Meteor(pg.sprite.Sprite):
    def __init__(self, width, height):
        ...
        self.image = pg.image.load(r"C:\Users\Nirawit EN\OneDrive\เดสก์ท็อป\CPCU\ComProg\Workshop\workshop8-pygame2\source\img\meteor_med.png")
        self.image= pg.transform.scale(self.image,(width,height))
        self.rect = self.image.get_rect()
...
while True:
    ...
    hit = pg.sprite.spritecollide(myShip,meteor_sprites,False)
